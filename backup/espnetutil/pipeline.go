...
type PipelineHandler func(in Channel, msg *esnp.Message, out Channel) error
...
func (this *Connector) LeftSendMessage(msg *esnp.Message) error {
	if this.right != nil {
...
func (this *Connector) RightSendMessage(msg *esnp.Message) error {
	if this.left != nil {
...
func (this *Pipeline) LeftSendMessage(msg *esnp.Message) error {
	if this.right != nil {
		if this.LeftToRightHandler != nil {
			return this.LeftToRightHandler(this.left, msg, this.right)
		}
...
func (this *Pipeline) RightSendMessage(msg *esnp.Message) error {
	if this.left != nil {
		if this.RightToLeftHandler != nil {
			return this.RightToLeftHandler(this.right, msg, this.left)
		}
