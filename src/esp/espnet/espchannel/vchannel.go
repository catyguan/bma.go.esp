...
type VChannel struct {
	...
	peer   esnp.MessageListener
	Sender esnp.MessageListener
...
func (this *VChannel) SetMessageListner(rec esnp.MessageListener) {
	this.peer = rec
}
...
func (this *VChannel) ServiceResponse(msg *esnp.Message) error {
	if this.peer != nil {
